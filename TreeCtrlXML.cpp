...
void CTreeCtrlXML::Save(tinyxml2::XMLNode* a_pNode)
{
	//ASSERT( NULL != a_pNode );

	//tinyxml2::XMLNode* pItems = a_pNode;// ->InsertEndChild(TiXmlElement("Items"));
	//tinyxml2::XMLNode* pParent = pItems;
	//tinyxml2::XMLNode* pNewNode = NULL;
	//HTREEITEM hItem = GetRootItem();

	//XMLElement* pElement = NULL;
	//pElement = NewElement("Item");
	////tinyxml2::XMLDocument xmlDoc;

	////XMLElement* pElement = xmlDoc.NewElement("Item");
	////tinyxml2::XMLElement* elItem = xmlDoc.NewElement("Item");

	////a_pNode->InsertEndChild(el);
	////HTREEITEM hti;
	//int iIndent = 0; int iLastIndent = 0;
	...
	//		while (iDiff--)
	//			pNewNode = pNewNode->InsertEndChild(pElement);
	//		xmlDoc.InsertEndChild(pNewNode);
	...
	//		ASSERT(NULL != pParent);
	//		pNewNode = pParent->InsertEndChild(pElement);
	//		xmlDoc.InsertEndChild(pNewNode);
	//	}
	//	else
	//	{
